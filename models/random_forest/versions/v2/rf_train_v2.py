...
# 3. RANDOM FOREST HİPERPARAMETRE IZGARASI (GridSearch)
...
grid_search = GridSearchCV(
    ...
    n_jobs=-1,  # Tüm işlemci çekirdeklerini kullan (M2 devrede)
    verbose=2
)

# 5. EĞİTİMİ BAŞLAT
print("\n[EĞİTİM BAŞLIYOR] M2 işlemcisi tüm çekirdekleriyle devrede...")
