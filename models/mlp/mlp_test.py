...
model_adi = f'mlp_model_v{son_versiyon_no}.pkl'
...
print("\n=== NİHAİ TEST BAŞARI KARNESİ (Mw Uzayında) ===")
...
plt.plot([min_val, max_val], [min_val, max_val], 'r--', lw=2,
         label='Mükemmel Tahmin (45°)')
plt.xlabel("Gerçek Büyüklük (Mw)", fontsize=12)
plt.ylabel("Tahmin Edilen Büyüklük (Mw)", fontsize=12)
plt.title(f"Gerçek vs Tahmin — MLP (v{son_versiyon_no})\n"
          f"RMSE: {test_rmse:.4f} | R²: {test_r2:.4f}", fontsize=13)
...
print("\nÖNEMLİ: Tüm metrikler Mw (Büyüklük) uzayında hesaplanmıştır.")
print("          Bu, RF ve XGBoost sonuçlarıyla adil karşılaştırma sağlar.")
